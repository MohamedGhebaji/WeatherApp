...
class CoreDataHelper: NSObject {
    ...
    var store = appDelegate.coreDataStore
    ...
    func saveContext(context: NSManagedObjectContext, completion:((NSError?) -> Void)?) {
    ...
    func saveContextWithCompletion(completion:((NSError?) -> Void)? = nil) {
        self.saveContext(self.backgroundContext!, completion: completion)
    }
